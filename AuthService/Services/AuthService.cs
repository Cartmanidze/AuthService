...
namespace AuthService.Services
{
    public class AuthService : IAuthService
    {
        ...
        private readonly ITokenGetterService _tokenGetterService;

        public AuthService(UserManager<User> userManager, ITokenGetterService tokenGetterService)
        {
            _userManager = userManager;
            _tokenGetterService = tokenGetterService;
        }
        ...
        public async Task<ObjectResult> Login(LoginModel loginModel)
        {
            ...
            var token = _tokenGetterService.GetToken(user.Id, DateTime.Now, userRoles);
